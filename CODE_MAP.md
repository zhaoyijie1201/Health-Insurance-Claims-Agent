...
## 目前 scripted 后端的结果（2026-09-05，15 条 shipped 案例）

| 运行 | 通过 | turn 中位/最大 | 输入 token | 说明 |
|---|---|---|---|---|
| careful v2（并行） | 33/33 | 2 / 4 | 244,174 | CLM-8842 正好 4 turn，CLM-8925 正好 2 turn |
| sequential v2 | 33/33 | 2 / 8 | 335,837 | 并行比串行少 27% 输入 token |
| careful v1 工具 | 27/33 | 3 / 4 | 179,412 | 两条注入案例全挂；prompt 更短但不安全 |
| repeats，去重开 | 9/33 | 3 / 3 | 204,542 | 24 次在第 3 轮被 duplicate_action 拦下 |
| repeats，去重关 | 9/33 | 10 / 10 | 764,534 | 24 次跑到 step cap；预算上限没触发 |
| credulous v1 / v2 | 27/33 / 33/33 | | | v2 写操作 BLOCKED 后转 escalate |
