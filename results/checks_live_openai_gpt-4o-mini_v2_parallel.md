# Checks used, case by case · live_openai/gpt-4o-mini_v2_parallel

backend live · model openai/gpt-4o-mini · tools v2 · 2026-09-05 · 91 trials. CODE = harness.code_check against the answer key (decision, trigger, named line, approved_total, gated action once). JUDGEMENT = model: google/gemini-2.5-flash ruling on every must_record item with the prompt in docs/JUDGE_PROMPT.md.
...
| CLM-8917 | outside_policy_dates | escalate | code + judgement | FAIL 2/3 | decision, trigger, gated_once | PASS 2/2 |  |
...
| CLM-9006 | boundary_preauth_valid_last_day | approve_in_principle | code + judgement | PASS 1/1 | decision, approved_total, gated_once | FAIL 1/3 | PA-9002 cited for line 27447; validity 2026-06-01 to 2026-09-19 contains the date of service 2026-09-19 |
...
| CLM-9014 | required_document_absent_with_valid_preauth | request_document | code + judgement | FAIL 2/3 | decision, missing_line, gated_once | FAIL 1/2 | PA-9001 found and valid on 2026-09-30 |
| CLM-9015 | two_preauth_one_expired | request_document | code + judgement | FAIL 2/3 | decision, missing_line, gated_once | FAIL 0/3 | PA-9002 found, validity ended 2026-09-19; 62480 resolved as covered under PA-9001; the ask names 27447 and the date |
| CLM-9016 | required_document_absent_second_line | request_document | code + judgement | FAIL 1/3 | decision, missing_line, gated_once | PASS 2/2 |  |
| CLM-9017 | two_preauth_both_absent | request_document | code + judgement | PASS 3/3 | decision, missing_line, gated_once | FAIL 0/2 | both lines named, with the date; that nothing was found for either line (found is empty, not expired) |
| CLM-9018 | boundary_one_over_limit | escalate | code + judgement | FAIL 0/3 | decision, trigger, gated_once | FAIL 0/3 | claim total 5001; 5000 remaining on POL-8003; that lines were not individually priced |
| CLM-9019 | boundary_day_before_policy_start | escalate | code + judgement | PASS 3/3 | decision, trigger, gated_once | FAIL 1/3 | POL-8003 cover starts 2026-03-01; status active is not enough |
...
| CLM-9023 | duplicate_multi_line_lines_reordered | escalate | code + judgement | FAIL 0/3 | decision, trigger, gated_once | FAIL 1/2 | CLM-9090 named as the prior decision |
...
| CLM-9028 | preauth_belongs_to_other_member | request_document | code + judgement | FAIL 1/3 | decision, missing_line, gated_once | FAIL 1/2 | nothing found for this member and 62480 (found is empty, not expired) |
...
**29/45 cases pass the code check on every trial; 13/45 pass the judgement check; 11/45 pass both.**
