...
system prompt 1408 tokens, of which the tool block is 595. Observation tokens per call: check_coverage 52.5 (n=6), check_duplicate_claim 5.0 (n=6), get_claim 78.0 (n=12), issue_decision_letter 29.0 (n=12), lookup_hospital 21.5 (n=6), lookup_policy 73.5 (n=6)
