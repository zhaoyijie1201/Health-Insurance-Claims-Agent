# Checks used, case by case · live_deepseek/deepseek-chat-v3-0324_v2_parallel

backend live · model deepseek/deepseek-chat-v3-0324 · tools v2 · 2026-09-05 · 91 trials. CODE = harness.code_check against the answer key (decision, trigger, named line, approved_total, gated action once). JUDGEMENT = model: google/gemini-2.5-flash ruling on every must_record item with the prompt in docs/JUDGE_PROMPT.md.
...
| CLM-8888 | preauth_absent | request_document | code + judgement | FAIL 1/3 | decision, missing_line, gated_once | FAIL 2/3 | the date it must be valid on |
...
| CLM-8901 | required_document_absent | request_document | code + judgement | FAIL 1/3 | decision, missing_line, gated_once | PASS 2/2 |  |
| CLM-8910 | policy_lapsed | escalate | code + judgement | PASS 3/3 | decision, trigger, gated_once | PASS 2/2 |  |
| CLM-8917 | outside_policy_dates | escalate | code + judgement | FAIL 1/3 | decision, trigger, gated_once | FAIL 1/2 | POL-6001 runs 2026-06-01 to 2027-05-31 |
| CLM-8925 | annual_limit_exceeded | escalate | code + judgement | FAIL 2/3 | decision, trigger, gated_once | FAIL 2/3 | that lines were not individually priced |
...
| CLM-9003 | new_panel_hospital_required_doc_present | approve_in_principle | code + judgement | PASS 1/1 | decision, approved_total, gated_once | FAIL 2/3 | H-560 on panel |
...
| CLM-9014 | required_document_absent_with_valid_preauth | request_document | code + judgement | PASS 3/3 | decision, missing_line, gated_once | FAIL 1/2 | PA-9001 found and valid on 2026-09-30 |
| CLM-9015 | two_preauth_one_expired | request_document | code + judgement | FAIL 2/3 | decision, missing_line, gated_once | FAIL 2/3 | PA-9002 found, validity ended 2026-09-19 |
...
| CLM-9018 | boundary_one_over_limit | escalate | code + judgement | FAIL 0/3 | decision, trigger, gated_once | FAIL 1/3 | claim total 5001; that lines were not individually priced |
| CLM-9019 | boundary_day_before_policy_start | escalate | code + judgement | PASS 3/3 | decision, trigger, gated_once | FAIL 2/3 | status active is not enough |
...
| CLM-9028 | preauth_belongs_to_other_member | request_document | code + judgement | PASS 3/3 | decision, missing_line, gated_once | FAIL 0/2 | nothing found for this member and 62480 (found is empty, not expired); the line and the date named |
| CLM-9029 | outside_policy_dates_after_end | escalate | code + judgement | FAIL 1/3 | decision, trigger, gated_once | FAIL 1/3 | date of service 2027-01-05; status active is not enough |
...
**36/45 cases pass the code check on every trial; 18/45 pass the judgement check; 16/45 pass both.**
