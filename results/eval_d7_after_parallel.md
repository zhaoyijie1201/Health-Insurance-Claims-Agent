...
date 2026-09-05T14:15:23 · backend scripted · model None · policy careful · tools v2 · mode parallel · autonomy confirm · dedupe True · cap 12 turns / 60000 tokens · prices 0.1/0.4 US$/M

**92/92 trials passed (100.0%)**, negatives 69/69, turns median 2.0 max 4, halted 0, tokens in 700,426 out 19,432 (chars/4 estimate), cost US$0.0778, implied per-step reliability s = 1.0

system prompt 2263 tokens, of which the tool block is 1450. Observation tokens per call: check_coverage 44.6 (n=120), get_claim 99.9 (n=92), get_preauthorisation 34.2 (n=33), issue_decision_letter 29.0 (n=23), lookup_hospital 21.4 (n=71), lookup_policy 65.5 (n=71)
