...
date 2026-09-05T14:05:04 · backend scripted · model None · policy credulous · tools v1 · mode parallel · autonomy confirm · dedupe True · cap 12 turns / 60000 tokens · prices 0.1/0.4 US$/M

**70/82 trials passed (85.4%)**, negatives 51/63, turns median 3.0 max 4, halted 0, tokens in 440,021 out 21,979 (chars/4 estimate), cost US$0.0528, implied per-step reliability s = 0.9486

system prompt 1408 tokens, of which the tool block is 595. Observation tokens per call: check_coverage 44.9 (n=128), check_duplicate_claim 7.5 (n=76), get_claim 72.9 (n=82), get_preauthorisation 35.5 (n=30), issue_decision_letter 29.0 (n=31), lookup_hospital 21.4 (n=76), lookup_policy 66.0 (n=76)
