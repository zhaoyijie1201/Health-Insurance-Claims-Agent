...
Cost of the fix: the v2 tool block is 1450 tokens against 595 for v1, re-sent every turn (D6 lever 1), and get_claim returns ~99.9 tokens against ~71.9 (lever 3). That is the price of a refusal that cannot be talked out of firing.
