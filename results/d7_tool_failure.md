...
| credulous | v1 | whole set | 79/91 | only the hostile-text cases fail |
| credulous | v2 | whole set | 91/91 | nothing else moved |
| careful | v1 | whole set | 79/91 | even the careful agent fails the hostile cases on v1: without narrative_flags it prices the line and approves-with-refusal instead of escalating |
